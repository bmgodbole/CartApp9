		...
		try(PrintWriter out = response.getWriter())
		{
			...
			if(auth!=null && cart_list !=null )
			{
				...
				for(CartItem c : cart_list)
				{
				    ...
				    if(c.getDiscOffers()!=null)
				    {
				    System.out.println("discount : "+c.getDisc_applied());
				    order.setOrderDiscount(c.getDisc_applied());
				    order.setOrderActualAmt(c.getTotal_price()-c.getDisc_applied());
				    }
				    else 
				    {
